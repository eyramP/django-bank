...
from .emails import sent_account_locked_email
...
class User(AbstractUser):
    class SecurityQuestions(models.TextChoices):
        ...
        BIRTH_CITY = (
            "birth_city",
            _("What is the name of the city where you were born")
        )
        CHILDHOOD_FRIEND = (
            "childhood_friend",
    ...
    def reset_failed_login_attemtps(self) -> None:
