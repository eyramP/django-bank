...
class ProfileListAPiView(generics.ListAPIView):
    ...
    # Search fields are used by filters.SearchFIlter
    search_fields = ["user__first_name", "user__last_name", "user__id_no"]
    # filterset_fields are used by DjangoFilterBackend
...
class ProfileDetailView(generics.RetrieveUpdateAPIView):
            ...
            with transaction.atomic():
                ...
                if updated_instance.is_complete_with_next_of_kin():
                    ...
                    if not existing_account:
                        ...
                        message = (
                            "Profile updated and a new bank account created successfully An email had been sent to you with further details",
                        )
                    else:
                        message = (
                            "Profile updated successfully, no new account created as one exist already for this existing currency"
                        )
    ...
    # Partial Update is for patch request
...
class NextOfKingAPIView(generics.ListCreateAPIView):
    serializer_class = NextOfKinSerializer
    pagination_class = StandardResultPagination
    renderer_classes = [GenericJSONRenderer]
    object_label = "next_of_king"
...
class NextOfKinDetailsAPIView(generics.RetrieveUpdateDestroyAPIView):
    serializer_class = NextOfKinSerializer
    renderer_classes = [GenericJSONRenderer]
    ...
    def get_object(self) -> NextOfKin:
        ...
        self.check_object_permissions(self.queryset, obj)
        return obj
